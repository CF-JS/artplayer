   ...
   //执行一个 table 实例
    table.render({
      ...
      ,cols: [[ //表头
        ...
        ,{field: [5], title: '弹幕内容', width: 120,align:'center', sort: true}
       ...
       ,{field: [1], title: '时间点', sort: true, sort: true, align:'center', width: 100}
        ...
        ,{field: [9], title: '来源地址', width: 120, align:'center', sort: true}
...
//                ,{field: [8], title: '弹幕大小', width: 90}
      ...
      function delreport (id) {$.ajax({url: "./../?ac=del&type=report&id="+id,success: function(data){}});}
      function delid (id) {$.ajax({url: "./../?ac=del&type=list&id="+id,success: function(data){}});}
   });
